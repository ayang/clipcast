...
Because the original pyperclip can not process unicode characters on osx, I modified it and included in clipcast project.
The original project of pyperclip can be found in https://github.com/asweigart/pyperclip.
"""
